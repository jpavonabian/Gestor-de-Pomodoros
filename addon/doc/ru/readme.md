# Управление временем методом Помидора
...
Дополнение автоматически управляет циклами работы и отдыха, включая длительные перерывы после каждых четырёх завершённых циклов работы.

### Сочетания клавиш

Сочитания клавиш должны быть назначены самостоятельно по пути меню NVDA, Параметры подменю, диалог «Жесты ввода», категория «Управление временем методом помидора».
...
### 1.15
- Обновлён перевод на русский язык. [PR #3](https://github.com/jpavonabian/gestor-de-Pomodoros/pull/3)
### 1.14
...
- Дополнение не запускается на защищённых экранах.
